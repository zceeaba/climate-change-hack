...
# df1 = pd.read_csv('/Users/henrietta.ridley/climate_data/data/spei01.csv')

# df1.head()

# Read in GeoData for Niger
niger_admin = gpd.read_file(r"/Users/henrietta.ridley/climate_data/data/ner_adm03_feb2018/NER_adm03_feb2018.shp")
...
idx = np.where((df1['lon'] >= minx) & (df1['lon'] <= maxx) & (df1['lat'] >= miny) & (df1['lat'] <= maxy))
...
# or directly
niger_drought.to_file("/Users/henrietta.ridley/climate_data/data/niger_drought.shp")
